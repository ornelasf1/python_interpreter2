...
ifstream Lexical::inputFile;
string Lexical::lexeme = "";
char Lexical::nextChar;
CHARCLASS Lexical::charClass;
TOKENS Lexical::token;
vector<TOKENS> Lexical::tokens;
vector<std::string> Lexical::lexemes;
int Lexical::indentCount;
