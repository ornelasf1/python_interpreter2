...
extern std::streampos beginPosForLine;
extern std::string outputStreamMutations;
extern std::string outputStreamIfElseLvls;
extern std::string outputStreamRecFuncTerm;
extern std::string outputStreamIfElseError;
extern int funcStackDepthLIMIT;
